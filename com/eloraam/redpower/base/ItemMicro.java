...
public class ItemMicro extends ItemBlock
{
    ...
    private boolean useCover(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7)
    {
        ...
        else
        {
            ...
            {
                if (var3.canPlaceEntityOnSide(var1.itemID, var8.blockX, var8.blockY, var8.blockZ, false, var7, var2,(ItemStack)null))
                {
                    var3.setBlock(var8.blockX, var8.blockY, var8.blockZ, RedPowerBase.blockMicro.blockID, 0,3);
                }
