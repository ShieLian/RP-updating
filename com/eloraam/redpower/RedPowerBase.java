...
public class RedPowerBase
{
    ...
    public static void initBaseItems()
    {
        ...
        for (var0 = 0; var0 < 16; ++var0)
        {
            ...
            GameRegistry.addShapelessRecipe(new ItemStack(itemLumar, 2, var0), new Object[] {Item.redstone, var1, var1, Item.glowstone});
        }
    ...
    public static void initIndigo()
    {
        ...
        CraftLib.addShapelessOreRecipe(new ItemStack(itemLumar, 2, 11), new Object[] {Item.redstone, "dyeBlue", "dyeBlue", Item.glowstone});
    ...
    public static void initBlocks()
    {
        ...
        itemScrewdriver.setUnlocalizedName("screwdriver").setTextureName("RedPower/base:16");
