...
import com.eloraam.redpower.core.MathUtil;
    ...
    private int[] scanOutput()
    {
        ...
        else
        {
            ...
            if (var2 instanceof ISidedInventory)
            {
                ...
                var3=MathUtil.getMaxofList(var5.getAccessibleSlotsFromSide(var6.flag));
                /**@Corrected @Unknown*/
                //var4 = var5.getSizeInventorySide(var6);
                var4=var5.getAccessibleSlotsFromSide(var6.flag).length;
            }
