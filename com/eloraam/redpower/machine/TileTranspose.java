...
public class TileTranspose extends TileMachine implements ITubeConnectable
{
    ...
    protected int suckEntity(Object var1)
    {
        if (var1 instanceof EntityItem)
        {
            ...
            ItemStack var3 = var4.func_92014_d();
        ...
        else
        {
            if (var1 instanceof EntityMinecart)
            {
                ...
                EntityMinecart var2 = (EntityMinecart)var1;
    ...
    public boolean stuffCart(ItemStack var1)
    {
        ...
        {
            List var4 = this.worldObj.getEntitiesWithinAABB(EntityMinecart.class, this.getSizeBox(0.8D, 0.05D, 1.05D));
            ...
            while (var5.hasNext())
            {
                ...
                if (var6 instanceof EntityMinecart)
                {
                    EntityMinecart var7 = (EntityMinecart)var6;
