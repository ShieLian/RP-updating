...
public class CoreLib
{
    ...
    public static MovingObjectPosition traceBlock(EntityPlayer var0)
    {
        ...
        return var0.worldObj.rayTraceBlocks_do_do(var1, var2,false, false);//.rayTraceBlocks(var1, var3);
    }
	...
	public static MovingObjectPosition retraceBlock(World var1,EntityPlayer var5, int var2, int var3, int var4)
	{
		// TODO 自动生成的方法存根
		/**Unknown*/
		return retraceBlock(var1,(EntityLiving)(EntityLivingBase)var5, var2, var3, var4);
	}
}
