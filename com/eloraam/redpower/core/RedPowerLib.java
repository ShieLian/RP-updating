...
public class RedPowerLib
{
    ...
    {
        if (!var0.editingBlocks && !CoreLib.isClient(var0))
        {
    ...
    public static boolean isStrongPoweringTo(IBlockAccess var0, int var1, int var2, int var3, int var4)
    {
        int var5 = var0.getBlockId(var1, var2, var3);
    ...
    public static boolean isStrongPowered(IBlockAccess var0, int var1, int var2, int var3, int var4)
    {
        return var4 != 1 && isStrongPoweringTo(var0, var1, var2 - 1, var3, 0) ? true : (var4 != 0 && isStrongPoweringTo(var0, var1, var2 + 1, var3, 1) ? true : (var4 != 3 && isStrongPoweringTo(var0, var1, var2, var3 - 1, 2) ? true : (var4 != 2 && isStrongPoweringTo(var0, var1, var2, var3 + 1, 3) ? true : (var4 != 5 && isStrongPoweringTo(var0, var1 - 1, var2, var3, 4) ? true : var4 != 4 && isStrongPoweringTo(var0, var1 + 1, var2, var3, 5)))));
    }
    ...
    public static boolean isPoweringTo(IBlockAccess var0, int var1, int var2, int var3, int var4)
    {
        ...
        else if (Block.blocksList[var5].isProvidingWeakPower(var0, var1, var2, var3, var4))
        {
            return true;
        }
        else if (var0.isBlockNormalCube(var1, var2, var3) && isStrongPowered(var0, var1, var2, var3, var4))
        {
            return true;
        }
        else
        {
            if (var4 > 1 && var5 == Block.redstoneWire.blockID)
            {
                ...
                if (Block.blocksList[var5].isProvidingWeakPower(var0, var1, var2, var3, 1))
                {
                    return true;
                }
            }
    ...
    {
        return (var4 & 17895680) > 0 && isWeakPoweringTo(var0, var1, var2 - 1, var3, 0) ? true : ((var4 & 35791360) > 0 && isWeakPoweringTo(var0, var1, var2 + 1, var3, 1) ? true : ((var4 & 71565329) > 0 && isWeakPoweringTo(var0, var1, var2, var3 - 1, 2) ? true : ((var4 & 143130658) > 0 && isWeakPoweringTo(var0, var1, var2, var3 + 1, 3) ? true : ((var4 & 268452932) > 0 && isWeakPoweringTo(var0, var1 - 1, var2, var3, 4) ? true : ((var4 & 536905864) > 0 && isWeakPoweringTo(var0, var1 + 1, var2, var3, 5) ? true : ((var5 & 1) > 0 && isPoweringTo(var0, var1, var2 - 1, var3, 0) ? true : ((var5 & 2) > 0 && isPoweringTo(var0, var1, var2 + 1, var3, 1) ? true : ((var5 & 4) > 0 && isPoweringTo(var0, var1, var2, var3 - 1, 2) ? true : ((var5 & 8) > 0 && isPoweringTo(var0, var1, var2, var3 + 1, 3) ? true : ((var5 & 16) > 0 && isPoweringTo(var0, var1 - 1, var2, var3, 4) ? true : (var5 & 32) > 0 && isPoweringTo(var0, var1 + 1, var2, var3, 5)))))))))));
    }
    ...
    private static int getSidePowerMask(IBlockAccess var0, int var1, int var2, int var3, int var4, int var5)
    {
        ...
        {
            return var4 != 0 ? 0 : (isWeakPoweringTo(var0, var1, var2, var3, var5) ? var7 & 16777215 : (isPoweringTo(var0, var1, var2, var3, var5) ? var7 : 0));
        }
    }
