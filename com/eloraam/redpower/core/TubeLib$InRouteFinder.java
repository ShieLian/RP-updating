    ...
    public void addPoint(WorldCoord var1, int var2, int var3, int var4)
    {
        ...
        else
        {
            ...
            if (var5 instanceof ISidedInventory)
            {
                ...
                /**@Unknown*/
                var7 = var9.getAccessibleSlotsFromSide(ForgeDirection.getOrientation(var6).flag)[0];//.getStartInventorySide(ForgeDirection.getOrientation(var6));
                var8 = var9.getAccessibleSlotsFromSide(ForgeDirection.getOrientation(var6).flag).length;
            }
