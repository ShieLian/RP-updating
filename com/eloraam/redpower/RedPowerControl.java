...
public class RedPowerControl
{
    ...
    private static void setupBlocks()
    {
        ...
        ChestGenHooks.addItem("dungeonChest",new WeightedRandomChestContent(new ItemStack(itemDisk, 1, 1), 1,1,2));
        ChestGenHooks.addItem("dungeonChest",new WeightedRandomChestContent(new ItemStack(itemDisk, 1, 2), 1,1,2));
