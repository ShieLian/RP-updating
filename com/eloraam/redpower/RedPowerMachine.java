...
public class RedPowerMachine
{
    ...
    private static void setupItems()
    {
        ...
        itemSonicDriver.setUnlocalizedName("sonicDriver").setIconIndex(129);
        ...
        itemWoodWindmill.setIconIndex(178).setItemName("windmillWood");
    ...
    private static void setupBlocks()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(blockMachine, 1, 1), new Object[] {"SAS", "SPS", "SRS", 'S', Block.cobblestone, 'A', Item.pickaxeSteel, 'R', Item.redstone, 'P', Block.pistonBase});
